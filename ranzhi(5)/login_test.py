...
from util import BoxDriver,GetExcel,GetCSV
...
class LoginTest(unittest.TestCase):
    ...
    @parameterized.expand(GetCSV().get(r'ranzhi\sample.csv'))
    ...
    @parameterized.expand(GetExcel().get(r'ranzhi\data.xlsx','login_fail'))
